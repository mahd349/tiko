...
"footer.made": "ساخته‌شده در ایران",
"footer.rights": "تمامی حقوق محفوظ است",
   ...
   "form.moreSettings": "تنظیمات بیشتر",
      "common.goal": "هدف",
      "common.color": "رنگ",
      "common.icon": "نماد",
      ...
      "tasks.priorityLow": "کم‌اهمیت",
       "tasks.recurrence": "تکرار",
"tasks.recNone": "تکرار نمی‌شود",
"tasks.recDaily": "هر روز",
"tasks.recWeekly": "هر هفته",
"tasks.recMonthly": "هر ماه",
"tasks.recEvery": "هر",
"tasks.recDayUnit": "روز",
"tasks.recWeekUnit": "هفته",
"tasks.recMonthUnit": "ماه",
"tasks.recEndDate": "تاریخ پایان (اختیاری)",
"tasks.recDays": "روزهای هفته",
...
"projects.deleted": "پروژه حذف شد",
      ...
      "toast.taskDeleted": "وظیفه حذف شد",
      "toast.habitAdded": "عادت اضافه شد",
      "toast.habitDeleted": "عادت حذف شد",
      ...
      "toast.timerStarted": "تایمر شروع شد",
      ...
      "toast.dataReset": "همهٔ داده‌ها پاک شد",
      ...
      "toast.storageUnavailable": "حافظهٔ دائمی در این حالت در دسترس نیست",

      "modal.editTask": "ویرایش وظیفه",
      "modal.editHabit": "ویرایش عادت",
      "modal.deleteHabit": "حذف عادت",
      ...
      "modal.resetTitle": "پاک‌کردن همهٔ داده‌ها",
...
"projects.namePlaceholder": "نام پروژه…",
"projects.select": "انتخاب پروژه",
"projects.none": "بدون پروژه",
"projects.manage": "مدیریت پروژه‌ها",
"projects.empty": "هنوز پروژه‌ای نداری",
"projects.emptySub": "با ساخت یک پروژه، وظایف و عادت‌هایت را دسته‌بندی کن.",
"subtasks.title": "زیروظیفه‌ها",
"subtasks.add": "+ افزودن زیروظیفه",
"subtasks.placeholder": "زیروظیفه جدید…",
"subtasks.progress": "{done} از {total}",
"tags.title": "برچسب‌ها",
"tags.add": "+ برچسب",
"tags.placeholder": "برچسب جدید…",
...
"notes.search": "جستجوی یادداشت‌ها",
       "features.tasksTitle": "مدیریت وظایف",
"features.tasksDesc": "وظایف روزانه با تاریخ و اولویت؛ کارهای عقب‌افتاده خودکار مشخص می‌شوند.",
"features.streakTitle": "استریک عادت‌ها",
"features.streakDesc": "روزهای پشت‌سرهم و بهترین رکورد هر عادت را ببینید.",
"features.calendarTitle": "تقویم شمسی",
"features.calendarDesc": "تقویم دقیق شمسی با نقشهٔ حرارتی ۶ ماه اخیر.",
"features.chartsTitle": "نمودار پیشرفت",
"features.chartsDesc": "نرخ تکمیل هفتگی، روند ۳۰ روزه و نمودار هر عادت.",
"features.privacyTitle": "حریم خصوصی",
"features.privacyDesc": "هیچ داده‌ای به سرور ارسال نمی‌شود؛ پشتیبان کامل با یک کلیک.",
"faq.q1": "آیا اطلاعات من امن است؟",
"faq.a1": "بله. داده‌ها فقط در مرورگر شما ذخیره می‌شوند و به سروری ارسال نمی‌شوند.",
"faq.q2": "چگونه پشتیبان بگیرم؟",
"faq.a2": "از بخش ابزارها → پشتیبان استفاده کنید. فایل JSON را در جای امن نگه دارید.",
"faq.q3": "استریک چطور حساب می‌شود؟",
"faq.a3": "هر روز کامل = یک روز استریک. از دست دادن یک روز، شمارش را از صفر شروع می‌کند.",
"home.listEyebrow": "فهرست امروز",
"home.tasksTitle": "وظایف امروز",
"home.habitsEyebrow": "پیگیری روزانه",
"home.habitsTitle": "عادت‌های امروز",
...
"footer.contact": "تماس",
"footer.allArticles": "همهٔ مقاله‌ها",
"footer.made": "ساخته‌شده با ❤️ در ایران",
"footer.rights": "تمامی حقوق محفوظ است",
"tasks.eyebrow": "مدیریت",
"habits.eyebrow": "روتین روزانه",
"today.eyebrow": "نمای کلی",
"notes.eyebrow": "دفترچه",
"stats.breakdownEyebrow": "تفکیک",
"stats.breakdownTitle": "گزارش گروه‌ها",
"stats.weekEyebrow": "هفتهٔ جاری",
"stats.trendEyebrow": "روند"
    },
...
"footer.rights": "All rights reserved",
   ...
   "form.moreSettings": "More settings",
      "common.goal": "Goal",
      "common.color": "Color",
      "common.icon": "Icon",
...
"tasks.recNone": "Does not repeat",
"tasks.recDaily": "Daily",
"tasks.recWeekly": "Weekly",
"tasks.recMonthly": "Monthly",
"tasks.recEvery": "Every",
"tasks.recDayUnit": "day(s)",
"tasks.recWeekUnit": "week(s)",
"tasks.recMonthUnit": "month(s)",
"tasks.recEndDate": "End date (optional)",
"tasks.recDays": "Days of week",
     ...
     "landing.faq": "Frequently asked questions",
      ...
      "toast.dataReset": "All data deleted",
      ...
      "toast.storageUnavailable": "Persistent storage is unavailable in this mode",

      "modal.editTask": "Edit task",
      "modal.editHabit": "Edit habit",
      "modal.deleteHabit": "Delete habit",
...
"modal.resetTitle": "Delete all data",
...
"projects.emptySub": "Create a project to group your tasks and habits.",
"subtasks.title": "Subtasks",
"subtasks.add": "+ Add subtask",
"subtasks.placeholder": "New subtask…",
"subtasks.progress": "{done} of {total}",
"tags.title": "Tags",
"tags.add": "+ Tag",
...
"features.tasksDesc": "Daily tasks with dates and priorities; overdue items are flagged automatically.",
"features.streakTitle": "Habit streaks",
"features.streakDesc": "See consecutive days and the best record for each habit.",
"features.calendarTitle": "Persian calendar",
"features.calendarDesc": "An accurate Jalali calendar with a 6-month heatmap.",
"features.chartsTitle": "Progress charts",
"features.chartsDesc": "Weekly completion rate, 30-day trend and per-habit charts.",
"features.privacyTitle": "Privacy",
"features.privacyDesc": "Nothing is ever sent to a server; full backup with one click.",
"faq.q1": "Is my data safe?",
"faq.a1": "Yes. Data lives only in your browser and is never sent to any server.",
"faq.q2": "How do I back up?",
"faq.a2": "Tools → Backup. Keep the JSON file somewhere safe.",
"faq.q3": "How are streaks counted?",
"faq.a3": "Each complete day = one streak day. Missing a day restarts the count.",
"home.listEyebrow": "Today's list",
"home.tasksTitle": "Today's tasks",
"home.habitsEyebrow": "Daily tracking",
"home.habitsTitle": "Today's habits",
...
"habits.eyebrow": "Daily routine",
"today.eyebrow": "Overview",
"notes.eyebrow": "Notebook",
"stats.breakdownEyebrow": "Breakdown",
"stats.breakdownTitle": "Group report",
"stats.weekEyebrow": "Current week",
"stats.trendEyebrow": "Trend",
