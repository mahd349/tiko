...
{ id: "perfect_month", icon: "moon", fa: "ماه کامل", en: "Perfect month", df: "۳۰ روز پیاپی با پیشرفت حداقل ۷۰٪", de: "30 consecutive days at 70%+ progress", ok: d.maxRun70 >= 30, pr: pr(d.maxRun70, 30) }
];
}
function syncMedals() {
var g = game();
